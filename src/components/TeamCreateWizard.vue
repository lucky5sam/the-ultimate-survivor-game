        ...
        <div class="mx-auto w-full max-w-5xl">
          <div class="rounded-lg border border-border-subtle bg-surface-default p-6 sm:p-8">
            ...
            <div class="space-y-6 text-sm leading-relaxed text-text-subtle">
              <p>
                This is a for-fun fantasy game built around <em>Survivor</em>. It's a made-up game
                with made-up rules, run by Sam as the <strong>Commissioner and sole proprietor</strong>
                of the league. Where the rules are unclear or something unexpected comes up,
                <strong class="text-text-default">all decisions are finalized by the Commissioner
                based on his best judgment.</strong> Play hard, have fun, and don't take it too
                seriously.
              </p>
              ...
              >
                ...
                <p>
                  ...
                  <strong>Wednesday at 8:00 PM ET</strong> (episode airtime). Get your changes in
                  before then.
                </p>
              </div>
              ...
              <div>
                ...
                <ul class="list-disc space-y-1 pl-5">
                  ...
                  <li>
                    <strong>Rosters lock when the season starts.</strong> No new players may join
              ...
              <div>
                ...
                <ul class="list-disc space-y-1 pl-5">
                  <li>
                    Contestants earn points for in-game actions — winning immunity, finding an idol,
                    and more. The Commissioner logs these after each episode airs.
                  </li>
              ...
              <div>
                ...
                <ul class="list-disc space-y-1 pl-5">
                  <li>
                    Each week, pick <strong>one contestant you think will get voted out</strong> —
                    your bounty.
                  </li>
                  <li>
                    A correct pick earns <strong>5 points pre-merge</strong>,
                    <strong>10 post-merge</strong>, and <strong>15 for the finale</strong>.
                  </li>
                  <li>
                    Your pick locks <strong>Wednesday at 8:00 PM ET</strong>. Until then you can
                    change it freely, and only you can see your own un-locked pick. Your pick carries
                    over week to week until you change it.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul class="list-disc space-y-1 pl-5">
                  <li>
                    <strong>Contestant swap:</strong> drop a contestant and pick up another still in
                    the game. <strong>Role change:</strong> move your MVP to a different contestant.
                  </li>
                  <li>
                    <strong>Free swaps through Episode 2</strong> — change your roster or MVP as much
                    as you like for Episodes 1 and 2 at no cost. Starting with
                    <strong>Episode 3</strong>, penalties apply.
                  </li>
                  <li>
                  ...
                  <li>You get a maximum of <strong>10 swaps per season</strong>.</li>
                </ul>
              </div>
              ...
              <p>
                The Commissioner runs this league by hand and aims to get everything right, but is
                human. For any dispute, ambiguity, or situation the rules don't cover,
                <strong class="text-text-default">the Commissioner makes the final call.</strong>
                Rules may be adjusted between seasons. Thanks for playing! 🔥
              </p>
            </div>
